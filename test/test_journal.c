                       ...
                       uint64_t* outHash)
{
    ...
    m2RatchetJointDef pawlDef = m2DefaultRatchetJointDef();
    pawlDef.bodyIdA = anchor;
    pawlDef.bodyIdB = sidecar;
    pawlDef.ratchet = -0.3f;
    m2CreateRatchetJoint(world, &pawlDef); // op 56
