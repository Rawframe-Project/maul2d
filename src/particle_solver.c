...
//
// The particle solve pass: contacts with bodies, then the particle
// forces on the step's pair list, the velocity limit, the projection
// that keeps particles out of bodies, and the advance.
